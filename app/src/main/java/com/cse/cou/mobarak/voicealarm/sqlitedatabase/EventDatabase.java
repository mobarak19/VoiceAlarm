package com.cse.cou.mobarak.voicealarm.sqlitedatabase;
...
public class EventDatabase extends SQLiteOpenHelper {
    ...
    public static final String database_name="voice.alarm.db";
    public static final String table_name="voice.alarm.table";
    public static final String col1="id";
    public static final String col2="dat";
